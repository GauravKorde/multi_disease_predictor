...
with tabs[2]:
    ...
    alk = st.number_input("Alkaline Phosphotase", 50, 500, 200)
    alt = st.number_input("Alamine Aminotransferase", 0, 500, 30)
    ast = st.number_input("Aspartate Aminotransferase", 0, 500, 30)
    tp = st.number_input("Total Proteins", 0.0, 10.0, 6.0)
